package lab11.SimpleCalculator;// CalcModel.java
...
public class CalcModel {
    ...
    */
    ...
    public void multiply(String operand1, String operand2) {
        m_total = new BigInteger(operand1).multiply(new BigInteger(operand2));
    }
    ...
    public void add(String operand1, String operand2) {
        m_total = new BigInteger(operand1).add(new BigInteger(operand2));
    }
    public void sub(String operand1, String operand2) {
        m_total = new BigInteger(operand1).subtract(new BigInteger(operand2));
    }
