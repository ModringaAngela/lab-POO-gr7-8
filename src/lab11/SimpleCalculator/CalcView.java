package lab11.SimpleCalculator;// CalcView.java - View component
...
class CalcView extends JFrame {
    ...
    private JTextField m_userInput2Tf = new JTextField(5);
    private JTextField m_totalTf     = new JTextField(20);
    private JButton    m_multiplyBtn = new JButton("Multiply");
    private JButton    m_clearBtn    = new JButton("Clear");
    private JButton    m_addBtn = new JButton("Add");
    private JButton    m_subBtn = new JButton("Sub");
    ...
    void addAdditionListener(ActionListener cal) {
        m_addBtn.addActionListener(cal);
    }

    void addSubListener(ActionListener cal){m_subBtn.addActionListener(cal);}
